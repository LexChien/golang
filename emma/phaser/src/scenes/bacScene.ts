...
export default class bacScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.sprite(623, 207, 'bac', 'ui_table_a01.png'); //對其用
        ...
        //         panel: 10,
        //     },
        // }).drawBounds(this.add.graphics(), 0xff0000).layout();
    }
    ...
    public CreatElement() {
        ...
        let next_y = 282;
        for (let i = 0; i < 3; i++) {
            this.add.sprite(623, start_pos_y + next_y * i, 'bac', 'ui_table_a01.png'); //對其用
        }
        return obj;
    }
}
