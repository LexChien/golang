...
export default class RoomManager extends GridTable {
    constructor(scene) {
        super(scene)
        this.m_Scene = scene

        this.trackGameObject = scene.add.sprite(0, 0, 'bac', 'Bar_UI_02_2.png').setScale(1, 0);
        this.thumbGameObject = scene.add.sprite(0, 0, 'bac', 'Bar_UI_01.png')
